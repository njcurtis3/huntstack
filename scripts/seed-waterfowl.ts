...
const newSpecies = [
  ...
  },
  {
    ...
    category: 'waterfowl' as const,
    description: 'A subtly plumaged dabbling duck often overlooked but increasingly common. One of the most abundant ducks in the Central Flyway. Drakes have intricate vermiculated gray plumage.',
    habitat: 'Shallow marshes, prairie potholes, flooded agricultural fields, and alkaline lakes.',
    isMigratory: true,
    flyways: ['pacific', 'central', 'mississippi', 'atlantic'],
  },
  {
    ...
    category: 'waterfowl' as const,
    description: 'A medium-sized dabbling duck known for its distinctive white forehead patch ("baldpate"). Often feeds by stealing vegetation from diving ducks and coots.',
    habitat: 'Shallow marshes, flooded fields, lakes, and estuaries. Grazes on upland grasses near water.',
    isMigratory: true,
    flyways: ['pacific', 'central', 'mississippi', 'atlantic'],
  },
  {
    ...
    category: 'waterfowl' as const,
    description: 'Easily identified by its large spatulate bill used for filter-feeding. Often swims in tight circles to concentrate food. Populations have been increasing in recent decades.',
    habitat: 'Shallow marshes, mudflats, sewage lagoons, and flooded agricultural fields.',
    isMigratory: true,
    flyways: ['pacific', 'central', 'mississippi', 'atlantic'],
  },
  {
    ...
    category: 'waterfowl' as const,
    description: 'The largest North American diving duck, prized by hunters for its flavor. Distinctive sloping forehead profile. Populations fluctuate with prairie pothole conditions.',
    habitat: 'Deep marshes, lakes, bays, and estuaries. Breeds in prairie pothole region.',
    isMigratory: true,
    flyways: ['pacific', 'central', 'mississippi', 'atlantic'],
  },
  {
    ...
    category: 'waterfowl' as const,
    description: 'A medium-sized diving duck. Drakes have a round chestnut head. Often parasitizes canvasback nests. Important game species with specific bag limit restrictions in most flyways.',
    habitat: 'Deep freshwater marshes, lakes, and coastal bays. Winters heavily along Texas Gulf Coast.',
    isMigratory: true,
    flyways: ['central', 'mississippi', 'atlantic'],
  },
  {
    slug: 'scaup',
    name: 'Scaup',
    scientificName: 'Aythya (Greater and Lesser)',
    category: 'waterfowl' as const,
    description: 'Diving ducks known as "bluebills" by hunters. Greater and Lesser Scaup are difficult to distinguish in the field and are typically managed together. Populations have declined significantly since the 1980s.',
    habitat: 'Large lakes, rivers, bays, and coastal waters. Breeds in boreal forest and tundra.',
    isMigratory: true,
    flyways: ['pacific', 'central', 'mississippi', 'atlantic'],
  },
  {
    ...
    category: 'waterfowl' as const,
    description: 'A diving duck more accurately named for the white ring on its bill than the faint chestnut neck ring. Common in wooded swamps and beaver ponds. Populations have been increasing.',
    habitat: 'Wooded swamps, beaver ponds, bog lakes, and shallow freshwater marshes.',
    isMigratory: true,
    flyways: ['central', 'mississippi', 'atlantic'],
  },
  {
    ...
    category: 'waterfowl' as const,
    description: 'The smallest diving duck in North America. Named for its large, puffy head. Nests in old woodpecker holes. A fast, agile flyer that is challenging to hunt.',
    habitat: 'Small lakes, ponds, sheltered coastal bays, and rivers.',
    isMigratory: true,
    flyways: ['pacific', 'central', 'mississippi', 'atlantic'],
  },
  {
    ...
    category: 'waterfowl' as const,
    description: 'A small, compact stiff-tailed duck. Breeding males have bright blue bills. Often reluctant to fly, preferring to dive to escape danger.',
    habitat: 'Freshwater marshes, lakes, and ponds with emergent vegetation.',
    isMigratory: true,
    flyways: ['pacific', 'central', 'mississippi', 'atlantic'],
  },
  {
    ...
    category: 'waterfowl' as const,
    description: 'A non-migratory dabbling duck of the Gulf Coast, closely related to the mallard. Important game species in Texas and Louisiana coastal marshes.',
    habitat: 'Coastal marshes, rice fields, and freshwater wetlands along the Gulf Coast.',
    isMigratory: false,
    flyways: ['central', 'mississippi'],
  },
]
